        ...
        <form action="{{route('paginas.update',$pagina->id)}}" method="post">
            ...
            <div class="grid gap-6 py-2">
                <div>
                    ...
                    <x-input class="block mt-1 w-full" type="text" name="titulo" value="{{$pagina->pag_nombre}}">
                    </x-input>
                    @error('titulo')
            ...
            <div class="grid md:grid-cols-2 gap-6 py-2">
                <div>
                    ...
                    <select name="estado"
                        class="w-full border-gray-300 h-10 mt-1 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline"
                        placeholder="Seleccione un estado" required>
                        <option value="" selected disabled>Seleccione un estado</option>
                        <option value="1" @if($pagina->pag_estado == 1) selected @endif>Activo</option>
                        <option value="0" @if($pagina->pag_estado== 0) selected @endif>Inactivo</option>
                    </select>
                    @error('estado')
                    <b class="text-red-500">{{$message}}</b>
                    @enderror
                ...
                <div>
                    ...
                    <x-input class="block mt-1 w-full" placeholder="Ingrese el orden" value="{{$pagina->pag_orden}}"
            ...
            <div>
                <x-label for="contenido" class="font-sans font-semibold mb-2" value="Contenido de la pagina: ">
                </x-label>
                <textarea class="block mt-1 w-full" type="text" name="contenido">
