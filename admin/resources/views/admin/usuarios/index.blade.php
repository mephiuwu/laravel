...
<div class="px-4 md:px-10 mx-auto w-full -m-24">
    ...
    <footer class="block py-4">
        <div class="container mx-auto px-4">
            <hr class="mb-4 border-b-1 border-blueGray-200 flex flex-col items-center align-middle" />
...
<script>
    var message = @json(session('user_created'));
        console.log(message);
...
@php Session::forget('user_created') @endphp
...
@php Session::forget('user_updated') @endphp
