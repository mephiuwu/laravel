...
<div class="relative flex flex-col min-w-0 break-words w-full mb-6 mt-4 shadow-lg rounded  bg-white">
  ...
  <div style="min-height:calc(70vh - 80px); " class="block w-full p-4 overflow-x-auto">
    <form action="{{route('slider.store')}}" enctype="multipart/form-data" method="post">
      ...
      <div class="grid lg:grid-cols-3 gap-6">
        <div>
          ...
          <x-input class="block mt-1 w-full" type="text" name="sli_nombre" placeholder="Ingrese el nombre del slider">
          </x-input>
          @error('sli_nombre')
        ...
        <div>
          ...
          <x-input class="block mt-1 w-full" type="number" min="1" name="sli_orden"
            placeholder="Ingrese el orden del slider">
          </x-input>
          ...
          name="sli_orden" id="sli_orden">
            ...
            <option value="{{$activo->sli_orden}}" {{old('sli_orden') == $activo->sli_orden ? 'selected' : ''}} >
          {{$activo->sli_orden}}
          </option>
          @empty
      ...
      <div>
        ...
        <div class="px-4 py-6 sm:px-0 " id="croppie-container">
          ...
          <input type="hidden" id="url_croppie" name="url-image"
            class="relative inset-0 z-50 m-0 p-0 w-full h-full outline-none opacity-0">
          <div onclick="updatePreview()" id="container-preview"
            class="border-4 border-dashed flex flex-col border-gray-200 rounded-lg h-52 cursor-pointer  items-center justify-center ">
            ...
            <div class="flex text-center text-xl">
              (Tamaño minimo : 1370px X 470px)
            </div>
          </div>
        </div>
        <div class="flex w-full justify-center">
          @error('path_recorte_image')
          <b class="text-red-500 text-center">{{$message}}</b>
          @enderror
        </div>
    ...
    Adjuntar imagen
        ...
        <x-button id="btn-delete" type="button" class="btn-aeurus hidden bg-red-500  text-white font-sans font-bold ">
          Borrar Imagen
        </x-button>
